# This is the original source code for the script, please do not modify it without permission. It can break the code.
import whisper
...
def baixar_audio(url):
    if os.path.exists("video_audio.mp3"):
...
def salvar_resumo_em_arquivo(resumo, nome_arquivo="resumo_video.txt"):
    # Checks if the archive already exists and removes it, replacing it with a new one.
